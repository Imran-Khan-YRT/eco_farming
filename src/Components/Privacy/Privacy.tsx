...
import { listText_3, pageTitle, sectionTitle } from "../../Utils/customStyles";
    ...
    <>
      ...
      <Container padding="p-20 pt-5" className={`border rounded-lg h-[600px] overflow-scroll ${listText_3}`}>
        <p className="pb-10">
          ...
          illum rerum cum nobis. Impedit, molestiae esse nemo iste laboriosam similique repellendus. Assumenda a dolore accusantium! Dolorum at quia et ipsa ut, corrupti, eveniet quae repellat
          explicabo sint natus illum, esse ex iusto perspiciatis fugiat sed magnam. Labore quisquam ex cumque voluptate veritatis. Totam quidem doloremque est velit.
        </p>
        <ol className={`list-decimal space-y-4 `}>
          <li>
            Lorem ipsum dolor sit amet consectetur adipisicing elit. A cupiditate nemo nesciunt quibusdam et magnam, totam, nisi, hic labore ipsa dolores voluptates harum! Placeat quam, sequi ipsa
            amet tempore incidunt.
          </li>
          <li>
