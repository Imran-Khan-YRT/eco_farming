...
const Microfinance = () => {
  return (
    <>
      ...
      <Section title={data.microfinance.apply_for_loan.title} description={""} titleStyle={`${customText_0} md:mx-24 mx-10 `}></Section>
      <Container margined={false} backgroundColor="bg-tertiary" className="!mx-auto">
        <CustomizedSteppers />
      </Container>
    </>
  );
