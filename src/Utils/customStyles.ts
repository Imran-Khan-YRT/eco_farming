export const pageTitle = "lg:text-[2.7rem] md:text-[2.4rem] text-[2rem] font-poppins font-semibold my-4";
export const sectionTitle = "lg:text-[2.4rem] md:text-[2.2rem] text-[2rem] font-poppins  font-semibold py-4 pb-8";
...
export const listText_1 = "text-xl font-poppins font-normal";
